    ...
    <section id="servicios" className={styles.serviciosContainer}>
      ...
      <div className={styles.cardsContainer}>
        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Internación Psicogeriatrica</h3>
          <img className={styles.cardImg} src={psicogerontologia} alt="Internación Psicogeriatrica" />
        ...
        <div className={styles.card}>
          ...
          <img className={styles.cardImg} alt="Internación en Salud Mental" src={saludMental}/>
          <p className={styles.parrafo}>Internaciones breves</p>
          <p className={styles.parrafo}>Superar la situación que motivó la internación</p>
          <p className={styles.parrafo}>Reinserción Sociofamiliar</p>
        </div>

        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Centro de Día</h3>
          <img className={styles.cardImg} alt="Centro de día" src={centroDeDia}/>
        ...
        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Psicoterapia</h3>
          <img className={styles.cardImg} alt="Psicoterapia" src={psicoterapia}/>
        ...
        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Psiquiatría</h3>
          <img className={styles.cardImg} alt="Atención Psiquiátrica" src={atencionPsi}/>
      ...
      <div className={styles.cardsContainer}>
        <div className={styles.card}>
          ...
          <p className={styles.parrafo}>Mejora de la movilidad y funcionalidad</p>
          
          <p className={styles.parrafo}>Fortalecimiento muscular y equilibrio</p>
        </div>

        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Kinesiología</h3>
          <img className={styles.cardImg} alt="Kinesiología" src={kinesiologia}/>
          <p className={styles.parrafo}>Evaluación y tratamiento del movimiento</p>
          <p className={styles.parrafo}>Ejercicios terapéuticos personalizados</p>
          <p className={styles.parrafo}>Evaluación y tratamiento del movimiento</p>
          
        </div>

        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Neuropsicología</h3>
          <img className={styles.cardImg} alt="Neuropsicología" src={neuropsicologia}/>
          <p className={styles.parrafo}>Evaluación de funciones cognitivas</p>
          <p className={styles.parrafo}>Evaluación y tratamiento del movimiento</p>
          <p className={styles.parrafo}>Estimulación y entrenamiento cognitivo</p>
        </div>

        

        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Fonoaudiología</h3>
          <img className={styles.cardImg} alt="Fonoaudiología" src={fono} />
          <p className={styles.parrafo}>Rehabilitación del lenguaje y comunicación</p>
        ...
        <div className={styles.card}>
          <h3 className={styles.cardTitle}>Terapia Ocupacional</h3>
          <img className={styles.cardImg} alt="Terapia Ocupacional" src={terapiaOcupacional}/>
          <p className={styles.parrafo}>Rehabilitación de actividades cotidianas</p>
          <p className={styles.parrafo}>Promoción de la independencia funcional</p>
          <p className={styles.parrafo}>Evaluación y tratamiento del movimiento</p>
